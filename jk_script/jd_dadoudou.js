...
function taskUrl(_0x42e6cd, _0x50384a, _0x411802) {
    return {
        'url': _0x411802 ? 'https://lzkj-isv.isvjcloud.com/' + _0x42e6cd : 'https://lzkj-isv.isvjcloud.com/wxgame/' + _0x42e6cd,
        'headers': {
...
function getToken() {
    let {data} = getSign('isvObfuscator', {'id': '', 'url': $.activityUrl.match(/^https:\/\/[^\/]*\//)[0]})
    let _0xcc19fe = {
...
function getUUID(_0x22b9b1 = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', _0x55c604 = 0) {
    return _0x22b9b1.replace(/[xy]/g, function (_0x523bc0) {
        var _0x11a543 = (Math.random() * 0x10 | 0x0),
            _0x229f28 = (_0x523bc0 == 'x') ? _0x11a543 : (_0x11a543 & 0x3 | 0x8);
        if (_0x55c604) {
