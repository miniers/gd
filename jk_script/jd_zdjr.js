...
function getCk(){
    return new Promise(_0x5c0114=>{
        let _0x1421ee={'url':activityUrl+'/wxTeam/activity?activityId='+activityId,'headers':{
...
function taskPostUrl(_0x4e85b6,_0x1f0e72){
    return{'url':''+activityUrl+_0x4e85b6,'body':_0x1f0e72,'headers':{
...
function taskUrl(_0x4a2b20,_0x290f26){
    return{'url':'https://api.m.jd.com/client.action'+_0x4a2b20,'body':_0x290f26,'headers':{
...
function TotalBean(){
    return new Promise(async _0x4d5146=>{
        const _0x25151={'url':'https://wq.jd.com/user/info/QueryJDUserInfo?sceneval=2','headers':{
